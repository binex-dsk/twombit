...
public:
	...
	Color() {
		...
		contrast = 100;
		colortable_updated = false;
        colorTable[Mode::SMS]._RGB16 = new u16[64];
		colorTable[Mode::SMS]._RGB32 = new u32[64];
		colorTable[Mode::TMS]._RGB16 = new u16[16];
		colorTable[Mode::TMS]._RGB32 = new u32[16];
		colorTable[Mode::SMS_TMS]._RGB16 = new u16[16];
        colorTable[Mode::SMS_TMS]._RGB32 = new u32[16];
        colorTable[Mode::GG]._RGB16 = new u16[4096];
        colorTable[Mode::GG]._RGB32 = new u32[4096];
		active_filter = 0;
	...
	~Color() { 
		free_mem(colorTable[Mode::SMS]._RGB16);
		free_mem(colorTable[Mode::SMS]._RGB32);
		free_mem(colorTable[Mode::TMS]._RGB16);
		free_mem(colorTable[Mode::TMS]._RGB32);
		free_mem(colorTable[Mode::SMS_TMS]._RGB16);
		free_mem(colorTable[Mode::SMS_TMS]._RGB32);
        free_mem(colorTable[Mode::GG]._RGB16);
        free_mem(colorTable[Mode::GG]._RGB32);
	}
};
